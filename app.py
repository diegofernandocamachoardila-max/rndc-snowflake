...
# PRUEBA 1:
#
# 6 CAMPOS BASE QUE YA SABEMOS QUE FUNCIONAN
#
# +
#
# 2 CAMPOS NUEVOS:
...
VARIABLES_PROCESO4 = [
    ...
    # -------------------------------------------------------------------------
    # PRIMEROS 2 CAMPOS ADICIONALES A PROBAR
    # -------------------------------------------------------------------------
...
def cargar_dataframe_snowflake(
    ...
    try:
        ...
        # =================================================================
        # VERIFICAR TOTAL REAL EN SNOWFLAKE
        # =================================================================
